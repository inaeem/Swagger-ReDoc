# Pet Collection OpenAPI Specification
[![Build Status](https://travis-ci.org/inaeem/Swagger-ReDoc.svg?branch=master)](https://travis-ci.org/inaeem/Swagger-ReDoc)
...
6. If you did everything correct, https://inaeem.github.io/Swagger-ReDoc/ will lead to your new docs
...
- Documentation(ReDoc): https://inaeem.github.io/Swagger-ReDoc/
- SwaggerUI: https://inaeem.github.io/Swagger-ReDoc/swagger-ui/
- Look full spec:
    + JSON https://inaeem.github.io/Swagger-ReDoc/swagger.json
    + YAML https://inaeem.github.io/Swagger-ReDoc/swagger.yaml
- Preview spec version for branch `[branch]`: https://inaeem.github.io/Swagger-ReDoc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://inaeem.github.io/Swagger-ReDoc/ with url from the message: `Server started <url>`
